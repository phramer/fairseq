...
def load_score_files(args):
    ...
    for shard_id in shard_ids:
        ...
        pre_gen, left_to_right_preprocessed_dir, right_to_left_preprocessed_dir, backwards_preprocessed_dir, lm_preprocessed_dir = rerank_utils.get_directories(
            args.data_dir_name,
            args.num_rescore,
            args.gen_subset,
            args.gen_model_name,
...
def rerank(args):
    ...
    best_lenpen, best_weight1, best_weight2, best_weight3, best_score = match_target_hypo(
        args, write_targets, write_hypos
    )
